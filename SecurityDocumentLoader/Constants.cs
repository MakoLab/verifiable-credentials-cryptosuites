...
namespace SecurityDocumentLoader
{
    ...
    {
        internal const string Ed25519Signature2020ContextUrl = "https://w3id.org/security/suites/ed25519-2020/v1";
        internal const string VeresOneContextV1Url = "https://w3id.org/veres-one/v1";
